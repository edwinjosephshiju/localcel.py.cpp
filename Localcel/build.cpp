...
int main() {
    ...
    // 1. Compile Resources
    std::string rcCmd = "rc.exe /nologo /fo resources.res resources.rc";
    ...
    std::vector<std::string> srcs = {
        "main.cpp", "installer_ui.cpp", "dependency_manager.cpp", 
        "extractor.cpp", "hash_util.cpp", "process_util.cpp", 
        "supervisor.cpp", "logger.cpp"
    };
    ...
    clCmd += "resources.res /link /SUBSYSTEM:WINDOWS /OUT:Localcel.exe ";
    ...
    std::system("del *.obj resources.res >nul 2>&1");
